...
- Name: phase4-api-tests.spec.js >> Phase 4: API-Based Validation >> Phase 4.6: API Health Check - Plan endpoint returns valid structure
- Location: tests/e2e/phase4-api-tests.spec.js:377:7
